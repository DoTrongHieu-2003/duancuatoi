...
class PuzzlePage(tk.Frame):
    ...
    def display_widgets(self):
        ...
        self.label_heading = tk.Label(self.frame_title, text='Trò chơi ghép ảnh', **HEADING_LABEL_PROPERTIES)
        ...
        self.button_solve = tk.Button(self.frame_buttons, text='giải', command=lambda: self.solve_board(), **PRIMARY_BUTTON_PROPERTIES)
        ...
        self.button_shuffle = tk.Button(self.frame_buttons, text='nháo ảnh', command=lambda: self.shuffle_board(), **PRIMARY_BUTTON_PROPERTIES)
        self.button_shuffle.grid(row=0, column=2, padx=10, pady=20)
        
        self.button_change = tk.Button(self.frame_buttons, text='bắt đầu lại', command=lambda: self.change_algorithm(), **TERTIARY_BUTTON_PROPERTIES)
        self.button_change.grid(row=0, column=3, padx=10, pady=40)
